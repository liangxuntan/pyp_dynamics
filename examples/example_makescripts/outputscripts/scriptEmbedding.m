...
mkdir ~/pyp_run10/dataPYP/dataPsi
mkdir ~/pyp_run10/dataPYP/dataYA
addpath( './Dimitris', '~/pyp_run10/dataPYP/dataPsi', ...
         '~/pyp_run10/dataPYP/dataYA' );

if ifEmbed

    logfileEmbed = [ '~/pyp_run10/dataPYP/dataPsi/dataPsi', ...
                      '_nS',     int2str( nS ), ...
		              '_nN',     int2str( nN ),  ...
	                  '_nA',    int2str( nA ), ...
    ...
    logfileLaplacian = [ '~/pyp_run10/dataPYP/dataPsi/dataPsi', ...
                          '_nS',     int2str( nS ), ...fig
		                  '_nN',     int2str( nN ),  ...
	                      '_nA',    int2str( nA ), ...
			              '_sigma', num2str( sigma, '%1.2E' ), ...
    ...
    if nA > 0
        ...
        fileNameTune = [ '~/pyp_run10/dataPYP/dataYA/dataYA', ...
                         '_nS', int2str( nS ), ...
                         '_nN',    int2str( nNA ),  ...
                         '_nA',    int2str( nA ), ...
                         '.mat' ];
    ...
    fileName = [ '~/pyp_run10/dataPYP/dataPsi/dataPsi', ...
                 '_nS',    int2str( nS ), ...
                 '_nN',    int2str( nN ),  ...
                 '_nA',    int2str( nA ), ...
                 '_sigma', num2str( sigma, '%1.2E' ), ...
