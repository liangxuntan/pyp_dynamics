...
kOfInterest_new = [1]; % # of desired modes for the reconstruction M2-M3

% to load mask M corresponding to data matrix T:
file_Orig = '~/pyp_run11/dataPYP/dataPYP_femto_nS147799_nBrg15498.mat';

% to load reconstructdata from step(8)
sharedir_reconstruct = '~/pyp_run11/NLSA/'
