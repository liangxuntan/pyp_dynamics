...
%
  addpath('~/pyp_run11/sna/release/2.0/connecting',...
          ...
          '~/pyp_run11/dataPYP', ...
          '~/pyp_run11/dataPYP/dataPsi')
% loading data file located on the local host machine
load('~/pyp_run11/dataPYP/dataPYP_femto_nS147799_nBrg15498.mat','T');
X1 = T'; 
sigmaOpt=0.29;
sigmastr=sprintf('%3.2E',sigmaOpt);
dataPsi_template=(['~/pyp_run11/dataPYP/dataPsi/dataPsi_nS115031_nN15000_nA0_sigma' sigmastr '_nEigs4.mat']);
read_format = 'double';
